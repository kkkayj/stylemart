...
// Fetch products for "man" category
...
<head>
  ...
  <meta name="description" content="Men's Fashion - Stylemart Online Shopping" />
  <meta name="author" content="Stylemart" />
  <title>Men's Fashion | Stylemart</title>
    ...
    <div class="container px-4 px-lg-5">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
          ...
          <li class="nav-item"><a class="nav-link active" href="man.php">Man</a></li>
  ...
  <header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
      <div class="text-center text-white">
        <h1 class="display-4 fw-bolder">Men’s Collection</h1>
        <p class="lead fw-normal text-white-50 mb-0">Shop trendy looks with Stylemart</p>
      </div>
    </div>
  </header>
  ...
  <section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            <div class="col mb-5">
                <div class="card h-100" data-name="<?php echo htmlspecialchars($p['name']); ?>" data-price="<?php echo $p['price']; ?>">
                    <img class="card-img-top" src="<?php echo htmlspecialchars($p['image']); ?>" alt="<?php echo htmlspecialchars($p['name']); ?>" style="height:300px; object-fit:cover;" />
                    <div class="card-body p-4 text-center">
                        <h5 class="fw-bolder"><?php echo htmlspecialchars($p['name']); ?></h5>
                        RM<?php echo $p['price']; ?>
                    </div>
