...
// Fetch products for "woman" category
...
<title>Women's Fashion | Stylemart</title>
  ...
  <div class="container px-4 px-lg-5">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
        ...
        <li class="nav-item"><a class="nav-link active" href="woman.php">Woman</a></li>
...
<header class="bg-dark py-5">
  <div class="container text-center text-white">
    <h1 class="display-4 fw-bolder">Women's Collection</h1>
    <p class="lead fw-normal text-white-50 mb-0">Elegant & Modern Styles</p>
  </div>
</header>
